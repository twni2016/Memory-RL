"""
From https://github.com/ikostrikov/walk_in_the_park/blob/main/rl/distributions/tanh_transformed.py
"""
...
# but modified to only compute a mode, as  `mode` is not implemented for non-affine `bijectors`.
